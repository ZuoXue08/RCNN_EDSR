...
# The DIV2KJPEG class is for JPEG compressed DIV2K data set, set the corresponding file system path and file extension for subsequent data loading and processing.
