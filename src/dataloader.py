...
def _ms_loop(dataset, index_queue, data_queue, done_event, collate_fn, scale, seed, init_fn, worker_id):
    try:
        ...
        # Using shared memory mechanism to improve data merging efficiency and performance.
        ...
        # The main thread does not wait for the completion of the sub-threads, thereby avoiding program blocking.
    ...
    def __init__(self, loader):
        ...
        if self.num_workers > 0:
            ...
            for _ in range(2 * self.num_workers):
                self._put_indices()
# This code segment completes the initialization of the data loader iterator and sets up the multi-threading environment.
